...
CREATE TABLE IF NOT EXISTS products (
  ...
  productionCost NUMERIC(12, 2) NOT NULL,
  stock INTEGER,
...
CREATE TABLE IF NOT EXISTS orders (
  ...
  discountAsPercent NUMERIC(12, 2) NOT NULL,
  discountAsValue NUMERIC(12, 2) NOT NULL,
  feeServiceAsPercent NUMERIC(12, 2) NOT NULL,
  feeServiceAsValue NUMERIC(12, 2) NOT NULL,
  isFeeServiceTaxable BOOLEAN NOT NULL,
  feeTaxAsPercent NUMERIC(12, 2) NOT NULL,
  feeTaxAsValue NUMERIC(12, 2) NOT NULL,
...
CREATE TABLE IF NOT EXISTS generalSettings (
  ...
  feeService NUMERIC(12, 2) NOT NULL,
  isFeeServiceAlwaysUsed BOOLEAN NOT NULL,
  isFeeServiceTaxable BOOLEAN NOT NULL,
  feeTax NUMERIC(12, 2) NOT NULL,
